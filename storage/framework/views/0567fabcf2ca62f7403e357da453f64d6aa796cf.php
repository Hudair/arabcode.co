		...
		<table style="height: 100%; width: 100%; min-height: 500px; background: ghostwhite; padding: 1rem;">
			<tbody><tr><td>
				<table style="max-width: 600px;width: 100%;margin: auto;background: #fff;border-radius: 1rem;padding: 1.5rem;">
					<thead>
						<tr>
							<th><div style="padding: 1rem; margin-bottom: 3rem; font-size: 1.1rem; color: steelblue; background: ghostwhite; border-radius: 100px;"><?php echo e($subject); ?></div></th>
						</tr>
					</thead>
					<tbody>
						<tr>
						<td><div style="color: #2c2c2c; font-size: 1rem;"><?php echo nl2br($text); ?></div></td>
					</tr>
					</tbody>
					<tfoot>
						<tr>
...
</html><?php /**PATH D:\laragon\www\valexa\resources\views\mail\message.blade.php ENDPATH**/ ?>