...
<?php $__env->startSection('title', __('Create coupon')); ?>


<?php $__env->startSection('content'); ?>
<form class="ui large form" method="post" action="<?php echo e(route('coupons.store')); ?>" id="coupon" spellcheck="false">
	<?php echo csrf_field(); ?>

	<div class="field">
		<button class="ui icon labeled large purple circular button" type="submit">
		...
		<div class="column">
			...
			<div class="field" id="coupon-code">
				...
				<div class="ui right action input">
				  <input type="text" name="code" placeholder="..." value="<?php echo e(old('code')); ?>" autofocus required>
			...
			<div class="field">
				...
				<input type="number" step="0.01" name="value" placeholder="..." value="<?php echo e(old('value')); ?>" required>
			</div>

			<div class="field">
				<label><?php echo e(__('Is percentage')); ?></label>
				<div class="ui fluid dropdown selection floating">
					<input type="hidden" name="is_percentage" value="<?php echo e(old('is_percentage', '0')); ?>">
					<div class="text"></div>
					<div class="menu">
			...
			<div class="field">
				...
				<div class="ui fluid dropdown selection floating">
					<input type="hidden" name="for" value="<?php echo e(old('for', 'products')); ?>">
					<div class="text"></div>
					<div class="menu">
			...
			<div class="ui segment rounded-corner items products">
				<div class="field">
					...
					<div class="ui multiple search selection dropdown floating">
						<input type="hidden" name="products_ids" value="<?php echo e(old('products_ids')); ?>">
				...
				<div class="field">
					...
					<div class="ui selection dropdown floating">
						<input type="hidden" name="regular_license_only" value="<?php echo e(old('regular_license_only', '0')); ?>">
						<div class="text"></div>
						<i class="dropdown icon"></i>
						<div class="menu">
							<a class="item" data-value="1"><?php echo e(__('Yes')); ?></a>
			...
			<div class="ui segment rounded-corner items subscriptions d-none">
				<div class="field">
					...
					<div class="ui multiple search selection dropdown floating">
						<input type="hidden" name="subscriptions_ids" value="<?php echo e(old('subscriptions_ids')); ?>">
						<i class="dropdown icon"></i>
						<div class="text"></div>
						<div class="menu">
			...
			<div class="field">
				...
				<div class="ui selection dropdown floating">
					<input type="hidden" name="once" value="<?php echo e(old('once')); ?>">
					<div class="text"></div>
					<i class="dropdown icon"></i>
					<div class="menu">
						<a class="item" data-value="1"><?php echo e(__('Yes')); ?></a>
			...
			<div class="field">
				...
				<input type="datetime-local" name="starts_at" required value="<?php echo e(old('starts_at', date('Y-m-d\TH:i'))); ?>">
			</div>


			<div class="field">
				<label><?php echo e(__('Expires at')); ?></label>
				<input type="datetime-local" name="expires_at" required value="<?php echo e(old('expires_at', date('Y-m-d\TH:i'))); ?>">
			</div>
...
<script>
	$(function()
	{
		...
		$('.ui.dropdown.users').dropdown({values: <?php echo json_encode($users, 15, 512) ?>,}).dropdown('set selected', <?php echo e(old('users_ids')); ?>)
...
<?php echo $__env->make('back.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\valexa\resources\views\back\coupons\create.blade.php ENDPATH**/ ?>