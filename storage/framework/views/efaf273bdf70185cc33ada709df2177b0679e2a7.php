	...
	<div class="ui one column shadowless celled grid my-0 px-1" id="pricing">	
		...
		<div class="row">
			...
			<div class="column mx-auto px-0">
					...
					<div class="card">
						<div class="contents">
							...
							<div class="content buy">
								<?php if($active_subscription && !config('app.subscriptions.accumulative')): ?>
								<a class="ui large circular button disabled mx-0" style="background: <?php echo e($subscription->color ?? '#667694'); ?>">
				...
				<?php if($active_subscription && !config('app.subscriptions.accumulative')): ?>
				<small class="mt-2 d-block">* <?php echo e(__("It's not possible to subscribe to another membership plan while your previous one has not expired yet.")); ?></small>
				<?php endif; ?>
			</div>
		</div>
		<?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make(view_path('master'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\valexa\resources\views\front\tendra\pricing.blade.php ENDPATH**/ ?>