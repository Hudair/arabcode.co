		...
		<div class="ui main container" id="app">
			<div class="ui one column grid">
				...
				<div class="column">
					...
					<form class="ui grid form m-0" method="post" action="<?php echo e(route('home.install_app')); ?>" enctype="multipart/form-data">
						...
						<div class="ui fluid card">
							...
							<div class="content footer">
								<button class="ui large button ml-0 mr-auto" @click="navigateSteps(-1)" type="button" :class="{disabled: stepIsActive(1)}"><?php echo e(__('Previous')); ?></button>
...
</html><?php /**PATH D:\laragon\www\valexa\resources\views/install.blade.php ENDPATH**/ ?>