<div class="row first">
	...
	<div class="column">
		...
		<form class="ui large form newsletter" action="<?php echo e(route('home.newsletter', ['redirect' => url()->current()])); ?>" method="post">
			<?php echo csrf_field(); ?>
		...
		<div class="social-icons mx-auto justify-content-center mt-1">
			...
			<a class="ui circular white inverted icon button" href="<?php echo e(config('app.facebook')); ?>">
				<i class="large facebook icon"></i>
			</a>
			<?php endif; ?>

			<?php if(config('app.twitter')): ?>
			<a class="ui circular white inverted icon button" href="<?php echo e(config('app.twitter')); ?>">
				<i class="large twitter icon"></i>
			</a>
			<?php endif; ?>

			<?php if(config('app.pinterest')): ?>
			<a class="ui circular white inverted icon button" href="<?php echo e(config('app.pinterest')); ?>">
				<i class="large pinterest icon"></i>
			</a>
			<?php endif; ?>

			<?php if(config('app.youtube')): ?>
			<a class="ui circular white inverted icon button" href="<?php echo e(config('app.youtube')); ?>">
				<i class="large youtube icon"></i>
			</a>
			<?php endif; ?>

			<?php if(config('app.tumblr')): ?>
			<a class="ui circular white inverted icon button mr-0" href="<?php echo e(config('app.tumblr')); ?>">
...
<div class="row last">
	<div class="sixteen wide column">
	    ...
	    <?php if(config('app.affiliate.enabled')): ?>
...
</form><?php /**PATH D:\laragon\www\valexa\resources\views\front\valexa\partials\footer.blade.php ENDPATH**/ ?>