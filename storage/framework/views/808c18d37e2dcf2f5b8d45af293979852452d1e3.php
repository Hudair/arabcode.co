<div class="ui unstackable secondary menu top attached py-0 <?php echo e(route_is('home') ? 'home' : ''); ?>" id="top-menu">
  ...
  <form class="item search search-form" method="get" action="<?php echo e(route('home.products.q')); ?>">
  ...
  <div class="right menu pr-1"> 
    ...
    <div class="item ui dropdown categories">
      <div class="toggler">
        ...
        <div class="text mt-1-hf"><?php echo e(__('Categories')); ?></div>
      </div>
    ...
    <a href="<?php echo e(route('home.blog')); ?>" class="item blog">
      <i class="bold icon"></i>
      <span class="text"><?php echo e(__('Blog')); ?></span>
    </a>
    <?php endif; ?>
    
    <a href="<?php echo e(route('home.favorites')); ?>" class="item collection" title="Collection">
      <i class="heart outline icon"></i>
      <span class="text"><?php echo e(__('Collection')); ?></span>
    </a>
    ...
    <a href="<?php echo e(route('home.subscriptions')); ?>" class="item help">
      ...
      <span class="text"><?php echo e(__('Pricing')); ?></span>
    </a>
    <?php endif; ?>
    ...
    <div class="item notifications dropdown">
      <div class="toggler">
        ...
        <div class="text mt-1-hf"><?php echo e(__('Notifications')); ?></div>
      </div>
        ...
        <div>
          ...
          <div class="ui unstackable items">
            ...
            <a class="item mx-0"
              ...
              <div class="ui image">
                <?php if($notif->for == 0): ?>
                <img src="<?php echo e(asset_("storage/thumbnails/{$notif->image}")); ?>">
                <?php else: ?>
                <img src="<?php echo e(asset_("storage/avatars/{$notif->image}")); ?>">
                <?php endif; ?>
              </div>
    ...
    <div class="item cart dropdown">
      <div class="toggler">
        ...
        <div class="text mt-1-hf"><?php echo e(__('Shopping cart')); ?></div>
      </div>
  ...
  <div class="wrapper">
    ...
    <div class="sub-body" v-else>
      ...
      <div v-else-if="menu.mobile.type === 'languages'">
        ...
        <a class="item" href="<?php echo e(\LaravelLocalization::getLocalizedURL($locale_code)); ?>">
    ...
    <div class="footer">
      <div class="ui spaced buttons">
        <a href="<?php echo e(config('app.facebook')); ?>" class="ui basic icon button"><i class="large facebook icon"></i></a>
        <a href="<?php echo e(config('app.twitter')); ?>" class="ui basic icon button"><i class="large twitter icon"></i></a>
        <a href="<?php echo e(config('app.pinterest')); ?>" class="ui basic icon button"><i class="large pinterest icon"></i></a>
        <a href="<?php echo e(config('app.youtube')); ?>" class="ui basic icon button"><i class="large youtube icon"></i></a>
        <a href="<?php echo e(config('app.tumblr')); ?>" class="ui basic icon button"><i class="large tumblr icon"></i></a>
      </div>

      <p><?php echo e(config('app.name')); ?> © <?php echo e(date('Y')); ?> <?php echo e(__('all right reserved')); ?></p>
    </div>
  </div>
</div>
...
</div><?php /**PATH D:\laragon\www\valexa\resources\views\front\default\partials\top_menu.blade.php ENDPATH**/ ?>