		...
		<div class="payment-methods w-100">
		  ...
		  <div class="ui unstackable items" v-if="getTotalAmount() > 0 || customAmount > 0">
			...
			<div class="cart-payment cart-checkout">
				<form action="<?php echo e(route('home.checkout.payment')); ?>" method="post" id="form-checkout" class="ui big form" :class="{'d-none': !/^iyzico|paystack|payhere|coinpayments|sslcommerz|flutterwave$/.test(paymentProcessor) || (<?php echo e(var_export(\Auth::check())); ?> && paymentProcessor == 'paystack')}">
					<?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make(view_path('master'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\valexa\resources\views\front\valexa\checkout\shopping_cart.blade.php ENDPATH**/ ?>