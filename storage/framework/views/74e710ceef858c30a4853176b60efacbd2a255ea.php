...
<form class="ui large form" id="category" method="post" action="<?php echo e(route('categories.store')); ?>">
	<?php echo csrf_field(); ?>
	...
	<div class="field">
		...
		<div class="ui selection floating dropdown">
			<input type="hidden" name="for" value="<?php echo e(old('for')); ?>">
			<div class="text"></div>
			<div class="menu">
	...
	<div class="field">
		...
		<div class="ui selection floating dropdown parent-category">
			<input type="hidden" name="parent" value="<?php echo e(old('parent', '0')); ?>">
			<div class="text"></div>
			<div class="menu"></div>
		</div>
	</div>
	...
	<div class="field">
		...
		<input type="number" name="range" value="<?php echo e(old('range', '0')); ?>">
	</div>
...
<?php echo $__env->make('back.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\valexa\resources\views\back\categories\create.blade.php ENDPATH**/ ?>