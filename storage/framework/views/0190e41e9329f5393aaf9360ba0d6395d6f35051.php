...
unset($__errorArgs, $__bag); ?>
			    ...
			    <?php endif; ?>
					...
					<div class="field">
						<button class="ui circular large yellow button" type="submit"><?php echo e(__('Submit')); ?></button>
					</div>
				</form>
			</div>
		</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make(view_path('master'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\valexa\resources\views\front\tendra\support.blade.php ENDPATH**/ ?>