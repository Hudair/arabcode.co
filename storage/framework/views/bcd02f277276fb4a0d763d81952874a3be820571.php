...
<form class="ui large form" method="post" action="<?php echo e(route('posts.store')); ?>" enctype="multipart/form-data">
	<?php echo csrf_field(); ?>
	...
	<div class="one column grid" id="post">
		<div class="column">
			...
			<div class="field">
				...
				<textarea name="short_description" cols="30" rows="5"><?php echo e(old('short_description')); ?></textarea>
			</div>
			<div class="field">
				<label><?php echo e(__('Content')); ?></label>
				<textarea name="content" required class="summernote" cols="30" rows="20"><?php echo e(old('content')); ?></textarea>
			</div>
			<div class="field">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('back.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\valexa\resources\views\back\posts\create.blade.php ENDPATH**/ ?>