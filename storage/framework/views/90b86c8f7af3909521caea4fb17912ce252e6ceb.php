...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
	<head>
		...
		<?php echo place_ad('popup_ad'); ?>


		<?php echo place_ad('auto_ad'); ?>
    ...
    <!-- Spacing CSS -->
		...
		<!-- App CSS -->
		<link rel="stylesheet" href="<?php echo e(asset_('assets/front/tendra-'.locale_direction().'.css')); ?>">

		<!-- jQuery custom scrollbar -->
		<script type="application/javascript" src="<?php echo e(asset_('assets/jquery-custom-scrollbar/jquery.custom-scrollbar.min.js')); ?>"></script>

		<link rel="stylesheet" href="<?php echo e(asset_('assets/jquery-custom-scrollbar/jquery.custom-scrollbar.css')); ?>">
	...
	<body dir="<?php echo e(locale_direction()); ?>">
		...
		<div class="ui main fluid container <?php echo e(str_ireplace('.', '_', \Route::currentRouteName())); ?>" id="app">
			<div class="ui celled grid m-0 shadowless">
				...
				<div class="row">
					<?php echo $__env->make(view_path('partials.top_menu'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
				</div>
				...
				<footer id="footer" class="ui grid mx-auto px-0">
					<?php echo $__env->make(view_path('partials.footer'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
				</footer>
		...
		<?php echo $__env->yieldContent('pre_js'); ?>

		<!-- App JS -->
	  <script type="application/javascript" src="<?php echo e(asset_('assets/front/tendra.js')); ?>"></script>
...
</html><?php /**PATH D:\laragon\www\valexa\resources\views/front/tendra/master.blade.php ENDPATH**/ ?>