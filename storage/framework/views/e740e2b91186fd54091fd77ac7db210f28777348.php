	...
	<div class="row">
			...
			<div class="filter price">
				...
				<div class="ui form mt-2">
					<div class="three fields mb-0">
						...
						<div class="field">
							<label>&nbsp;</label>
							<a @click="applyPriceRange" class="ui grey circular icon button mr-0"><i class="right angle icon mx-0"></i></a>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="column right">
			<div class="ui results shadowless borderless menu">
				...
				<?php if(array_intersect(array_keys(request()->query()), ['price_range', 'tags', 'sort', 'cities', 'country'])): ?>
			...
			<div class="ui three doubling cards <?php if(config('app.masonry_layout')): ?> is_masonry <?php endif; ?>">
				@cards('item-card', $products, 'item', ['category' => 0, 'sales' => 1, 'rating' => 1])
			</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make(view_path('master'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\valexa\resources\views\front\valexa\products.blade.php ENDPATH**/ ?>