...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    ...
    <!-- Spacing CSS -->
		...
		<!-- App CSS -->
		<link rel="stylesheet" href="<?php echo e(asset_('assets/front/valexa-'.locale_direction().'.css')); ?>">
	...
	<body dir="<?php echo e(locale_direction()); ?>">
		...
		<!-- App JS -->
	  <script type="application/javascript" src="<?php echo e(asset_('assets/front/valexa.js')); ?>"></script>
...
</html><?php /**PATH D:\laragon\www\valexa\resources\views\front\valexa\master.blade.php ENDPATH**/ ?>