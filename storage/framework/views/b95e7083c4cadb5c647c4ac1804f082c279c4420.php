...
<?php $__env->startSection('title', __('Create product')); ?>
...
<div id="product" vhidden>
	<form class="ui large form main" method="post" enctype="multipart/form-data" action="<?php echo e(route('products.store')); ?>">
		<div class="field">
			...
			<a class="ui icon labeled large yellow circular button" :class="{disabled: anyInputOff()}" href="<?php echo e(route('products')); ?>">
			...
			<div class="column tabs">
			  ...
			  <div class="ui tab segment active" data-tab="overview">
			  	...
			  	<div class="field">
						...
						<input type="text" name="name" placeholder="..." value="<?php echo e(old('name')); ?>" autofocus required>
					</div>

					<div class="field">
						<label><?php echo e(__('Short description')); ?></label>
						<textarea name="short_description" cols="30" rows="3"><?php echo e(old('short_description')); ?></textarea>
					</div>

					<div class="field">
						<label><?php echo e(__('Category')); ?> <sup>(<?php echo e(__('Required')); ?>)</sup></label>
						<div class="ui selection floating search dropdown">
						  <input type="hidden" name="category" value="<?php echo e(old('category')); ?>">
						  <div class="default text">-</div>
						  <div class="menu">
					...
					<div class="field">
						<label><?php echo e(__('Subategories')); ?> <sup>(<?php echo e(__('Optional')); ?>)</sup></label>
						<div class="ui multiple selection floating search dropdown" id="subcategories">
							<input type="hidden" name="subcategories" value="<?php echo e(old('subcategories')); ?>">
					...
					<div class="mb-1" v-if="itemType === 'audio'">
						...
						<div class="field">
							...
							<input type="text" value="<?php echo e(old('bpm')); ?>">
						</div>

						<div class="field">
							<label><?php echo e(__('Bit Rate')); ?></label>
							<input type="number" value="<?php echo e(old('bit_rate')); ?>">
						</div>
					</div>
					...
					<div class="mb-1" v-if="itemType === 'ebook'">
						<div class="field">
							...
							<input type="number" name="pages" value="<?php echo e(old('pages')); ?>">
						</div>
						...
						<div class="field">
							...
							<input type="text" name="formats" value="<?php echo e(old('formats')); ?>">
						</div>

						<div class="field">
							<label><?php echo e(__('Words')); ?></label>
							<input type="text" name="words" value="<?php echo e(old('words')); ?>">
						</div>
					</div>

					<div class="field">
						<label><?php echo e(__('Tools used')); ?> <i class="exclamation circle icon" title="languages, libraries, frameworks..."></i></label>
						<input type="text" name="software" value="<?php echo e(old('software')); ?>" placeholder="...">
					</div>
					...
					<div class="mb-1" v-if="itemType === '-'">
						<div class="field">
							...
							<input type="text" name="database" value="<?php echo e(old('database')); ?>" placeholder="...">
						</div>
						...
						<div class="field">
							...
							<input type="text" name="compatible_browsers" value="<?php echo e(old('compatible_browsers')); ?>" placeholder="...">
						</div>
						...
						<div class="field">
							...
							<input type="text" name="compatible_os" value="<?php echo e(old('compatible_os')); ?>" placeholder="...">
						</div>
					</div>
					...
					<div class="field">
						...
						<input type="text" name="included_files" value="<?php echo e(old('included_files')); ?>" placeholder="...">
					</div>

					<div class="field">
						<label><?php echo e(__('Version')); ?></label>
						<input type="text" name="version" value="<?php echo e(old('version')); ?>" placeholder="...">
					</div>
					...
					<div class="field">
						...
						<input type="date" name="release_date" value="<?php echo e(old('release_date')); ?>" placeholder="...">
					</div>
					...
					<div class="field">
						...
						<input type="date" name="last_update" value="<?php echo e(old('last_update')); ?>" placeholder="...">
					</div>

					<div class="field">
						<label><?php echo e(__('High resolution')); ?></label>
						<div class="ui selection floating dropdown">
							<input type="hidden" name="high_resolution" value="<?php echo e(old('high_resolution')); ?>">
							<div class="text">...</div>
							<div class="menu">
					...
					<div class="field">
						...
						<input type="text" name="authors" value="<?php echo e(old('authors')); ?>">
					</div>

					<div class="field">
						<label><?php echo e(__('Tags')); ?> <sup>(<?php echo e(__('Optional')); ?>)</sup></label>
						<input type="text" name="tags" placeholder="<?php echo e(__('Comma-separated values')); ?>" value="<?php echo e(old('tags')); ?>">
					</div>

					<div class="field">
						<label><?php echo e(__('Preview link')); ?> <sup>(<?php echo e(__('Optional')); ?>)</sup></label>
						<input type="text" name="preview_url" class="d-block" placeholder="https://..." value="<?php echo e(old('preview_url')); ?>">
					</div>
					...
					<div class="field">
						...
						<div class="ui floating selection dropdown">
							<input type="hidden" name="enable_license" value="<?php echo e(old('enable_license')); ?>">
							<div class="text">...</div>
							<div class="menu">
								<a class="item" data-value="1"><?php echo e(__('Yes')); ?></a>
								<a class="item" data-value="0"><?php echo e(__('No')); ?></a>
					...
					<div class="field">
						...
						<div class="ui floating selection dropdown">
							<input type="hidden" name="for_subscriptions" value="<?php echo e(old('for_subscriptions', '0')); ?>">
							<div class="text">...</div>
							<div class="menu">
								<a class="item" data-value="1"><?php echo e(__('Yes')); ?></a>
								<a class="item" data-value="0"><?php echo e(__('No')); ?></a>
					...
					<div class="field">
						...
						<div class="ui floating search selection dropdown countries">
							<input type="hidden" name="country_city[country]" value="<?php echo e(old('country_city.country')); ?>">
							<div class="text">...</div>
							<div class="menu">
								<a class="item" data-value=""></a>
					...
					<div class="field">
						...
						<div class="ui floating search selection dropdown cities">
							<input type="hidden" name="country_city[city]" value="<?php echo e(old('country_city.city')); ?>">
							<div class="text">...</div>
							<div class="menu"></div>
						</div>
					</div>
									...
									<div class="w-100" v-else>
										...
										<div class="ui floating circular fluid dropdown large blue basic button mx-0 files" :class="{disabled: inputIsOff('download')}">
											...
											<div class="menu">
												...
												<a class="item" @click="browserMainFile('amazon_s3')"><?php echo e(__('Amazon S3')); ?></a>
												<?php endif; ?>

												

												<?php if(config('filehosts.google_drive.enabled')): ?>
												<a class="item" @click="browserMainFile('google')"><?php echo e(__('Google Drive')); ?></a>
												<?php endif; ?>

												<?php if(config('filehosts.wasabi.enabled') && !isFolderProcess()): ?>
												<a class="item" @click="browserMainFile('wasabi')"><?php echo e(__('Wasabi')); ?></a>
												<?php endif; ?>

												<?php if(config('filehosts.dropbox.enabled')): ?>
												<a class="item" @click="browserMainFile('dropbox')"><?php echo e(__('DropBox')); ?></a>
												<?php endif; ?>

												<?php if(config('filehosts.yandex.enabled') && !isFolderProcess()): ?>
												<a class="item" @click="browserMainFile('yandex')"><?php echo e(__('Yandex')); ?></a>
												<?php endif; ?>

												<a class="item" @click="browserMainFile('main_file_upload_link')"><?php echo e(__('Upload link')); ?></a>
												
												<?php if(!isFolderProcess()): ?>
												<a class="item" @click="browserMainFile('main_file_download_link')"><?php echo e(__('Download link')); ?></a>
												<?php endif; ?>
											</div>
										</div>

										<input type="url" name="main_file_upload_link" :class="{disabled: inputIsOff('download')}" placeholder="<?php echo e(__('Upload link')); ?>" value="<?php echo e(old('main_file_upload_link')); ?>" @change="setDefaultDrive" value="<?php echo e(old('main_file_upload_link')); ?>" class="mt-1">

										<?php if(!isFolderProcess()): ?>
										<input type="url" name="main_file_download_link" :class="{disabled: inputIsOff('download')}" placeholder="<?php echo e(__('Download link')); ?>" value="<?php echo e(old('main_file_download_link')); ?>" @change="setDefaultDrive" value="<?php echo e(old('main_file_download_link')); ?>" class="mt-1">
										<?php endif; ?>
									</div>
								</div>
							</div>
								...
								<div class="content">
									<div v-if="oldUploads.cover.length">
										<div class="ui fluid large pink label">
											...
											<i class="close icon ml-auto mr-0" @click="deleteExistingFile('<?php echo e("public/storage/covers/{$cover}"); ?>', 'cover')"></i>
										</div>	
									</div>
									<div class="w-100" v-else>
								...
								<div class="content">
									<div v-if="oldUploads.screenshots.length">
										<div class="ui fluid large pink label">
											...
											<i class="close icon ml-auto mr-0" @click="deleteExistingFile('<?php echo e("public/storage/covers/{$screenshots}"); ?>', 'screenshots')"></i>
										</div>	
									</div>
									<div class="w-100" v-else>
										...
										<button class="ui basic large circular blue fluid button" type="button" :class="{disabled: inputIsOff('screenshots')}" @click="selectFile('screenshots')"><?php echo e(__('Browse')); ?></button>
									</div>
								</div>
							</div>
							...
							<div class="fluid card">
								...
								<div class="content">
									...
									<div class="w-100" v-else>
										...
										<input type="url" name="preview_upload_link" :class="{disabled: inputIsOff('preview')}" placeholder="<?php echo e(__('Upload link')); ?>" value="<?php echo e(old('preview_upload_link')); ?>" value="<?php echo e(old('preview_upload_link')); ?>" class="mt-1">

										<input type="url" name="preview_direct_link" :class="{disabled: inputIsOff('preview')}" placeholder="<?php echo e(__('Direct link')); ?>" value="<?php echo e(old('preview_direct_link')); ?>" value="<?php echo e(old('preview_direct_link')); ?>" class="mt-1">

										<div class="ui floating circular fluid dropdown large blue basic button mt-1">
											<input type="hidden" name="preview_type" value="<?php echo e(old('preview_type')); ?>">
											<div class="text">...</div>
											<div class="menu">
												...
												<div class="item" data-value="-"><?php echo e(__('Other')); ?></div>
											</div>
										</div>
									</div>
								</div>
			  ...
			  <div class="ui tab segment" data-tab="description">
					<textarea name="overview" class="summernote"><?php echo old('overview'); ?></textarea>
			  </div>

			  <div class="ui tab segment" data-tab="hidden-content">
					<textarea name="hidden_content" class="summernote"><?php echo old('hidden_content'); ?></textarea>
			  </div>
			  	...
			  	<div class="table wrapper licenses <?php echo e($item_type); ?>" v-if="'<?php echo e($item_type); ?>' === itemType">
				  	<table class="ui basic table unstackable w-100">
					  	...
					  	<tr>
					  		...
					  		<td><input type="number" name="license[price][<?php echo e($license->id); ?>]" step="0.01" placeholder="<?php echo e(__('Default price')); ?>" <?php echo e(old("license.price.{$license->id}")); ?>></td>
					  		<td><input type="number" name="license[promo_price][<?php echo e($license->id); ?>]" step="0.01" placeholder="<?php echo e(__('Promo price')); ?>" value="<?php echo e(old("license.promo_price[$license->id]")); ?>"></td>
					  	</tr>
					  	<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
					  </table>
				  </div>
			  	...
			  	<div class="table wrapper free">
				  	<table class="ui basic table unstackable w-100">
					  	<tr>
					  		...
					  		<td><input type="number" step="0.0001" name="minimum_price" value="<?php echo e(old('minimum_price')); ?>"></td>
					  	</tr>
					  </table>
				  </div>
			  	...
			  	<div class="table wrapper free">
				  	<table class="ui basic table unstackable w-100">
					  	<tr>
					  		...
					  		<td><input type="text" name="free[from]" value="<?php echo e(old('free.from')); ?>" placeholder="<?php echo e(__('From')); ?> : YYYY-MM-DD"></td>
					  		<td><input type="text" name="free[to]" value="<?php echo e(old('free.to')); ?>" placeholder="<?php echo e(__('To')); ?> : YYYY-MM-DD"></td>
					  	</tr>
					  </table>
				  </div>
				  ...
				  <div class="table wrapper promo_price">
				  	<table class="ui basic table unstackable w-100">
					  	<tr>
					  		...
					  		<td><input type="text" name="promotional_price_time[from]" value="<?php echo e(old('promotional_price_time.from')); ?>" placeholder="<?php echo e(__('From')); ?> : YYYY-MM-DD"></td>
					  		<td><input type="text" name="promotional_price_time[to]" value="<?php echo e(old('promotional_price_time.to')); ?>" placeholder="<?php echo e(__('To')); ?> : YYYY-MM-DD"></td>
					  	</tr>
					  </table>
				  </div>
			  </div>
			  ...
			  <div class="ui tab segment" data-tab="table-of-contents">
			    <table class="ui celled unstackable single line table" 
						...
						<tbody>
							<?php if(old('text_type')): ?>
							
							<?php $__currentLoopData = old('text_type'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $text_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<tr>
								<td>
								...
								<td class="ten column wide right aligned">
									<input type="text" name="text[<?php echo e($key); ?>]" placeholder="..." value="<?php echo e(old('text')[$key] ?? ''); ?>" class="toc-text">
								</td>
							...
							<tr>
								<td>
									<div class="ui floating circular fluid dropdown large basic button mx-0">
										...
										<i class="dropdown icon"></i>
										<div class="menu">
											<a class="item" data-value="title"><?php echo e(__('Header')); ?></a>
											<a class="item" data-value="subtitle"><?php echo e(__('Subheader')); ?></a>
											<a class="item" data-value="subsubtitle"><?php echo e(__('Sub-Subheader')); ?></a>
										</div>
									</div>
								</td>
								<td class="ten column wide right aligned">
			  ...
			  <div class="ui tab segment" data-tab="faq" data-dict='{"Question": "<?php echo e(__('Question')); ?>", "Answer": "<?php echo e(__('Answer')); ?>", "Remove": "<?php echo e(__('Remove')); ?>", "Add": "<?php echo e(__('Add')); ?>"}'>
						<?php if(old('question') && old('answer')): ?>

							<?php $__currentLoopData = old('question') ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $qa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<div class="ui segment">
									...
									<div class="field">
										...
										<textarea name="answer[<?php echo e($k); ?>]" cols="30" rows="3" class="faq-answer" placeholder="..."><?php echo e(old('answer')[$k] ?? ''); ?></textarea>
									</div>
				...
				<div class="ui tab segment" data-tab="additional-fields" data-dict='{"Name": "<?php echo e(__('Name')); ?>", "Value": "<?php echo e(__('Value')); ?>", "Remove": "<?php echo e(__('Remove')); ?>", "Add": "<?php echo e(__('Add')); ?>"}'>
					<?php if(old('name') && old('answer')): ?>

							<?php $__currentLoopData = old('_name_') ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $qa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<div class="ui segment">
									<div class="two fields">
										<div class="three columns wide field">
											<label><?php echo e(__('Name')); ?></label>
											<input type="text" name="_name_[<?php echo e($k); ?>]" class="addtional-info-name" placeholder="..." value="<?php echo e($qa); ?>">
										</div>
										<div class="thirteen columns wide field">
											<label><?php echo e(__('Value')); ?></label>
											<input type="text" name="_value_[<?php echo e($k); ?>]" class="addtional-info-value" placeholder="..." value="<?php echo e(old('_value_')[$k] ?? ''); ?>">
										</div>
									</div>
									<div class="actions right aligned">
										<i class="times grey circle big icon link" data-action="remove" title="<?php echo e(__('Remove')); ?>"></i>
...
<script type="application/javascript">
	...
	var app = new Vue({
  	...
  	data: {
  		...
  		selectedDrive: '<?php echo e(old('file_host', '')); ?>',
  		...
  		searchFile: null,
  		parentFolder: null,
  		fileId: '<?php echo e(old('file_name')); ?>',
  		localFileName: '',
  		itemType: '<?php echo e(old('type', config('app.default_product_type') ?? '-')); ?>',
  		...
  		oldUploads: {
  			...
  			screenshots: "<?php echo e($screenshots); ?>",
	...
	function savePeaks(previewUrl, filename = null)
	{
		var wSuffer = WaveSurfer.create({
			...
			wSuffer.once('ready', () => 
			{
					...
					{
						$.post("<?php echo e(route('products.save_wave')); ?>", { filename: filename, peaks: res, id: '<?php echo e($product_id); ?>' })
						.always(function()
						{
	...
	function savePeaksFromTempUrl(url)
	{
		...
		$.post('<?php echo e(route('products.get_temp_url')); ?>', {url: url, id: '<?php echo e($product_id); ?>'})
	...
	$(function()
  {
  	<?php if(config('app.products_by_country_city')): ?>
	  	...
	  	<?php if($country = old('country_city.country')): ?>
			$('.ui.dropdown.cities').dropdown({
			...
			<?php if($city = old('country_city.city')): ?>
	  ...
	  .tab({
		...
		<?php if(old('category')): ?>
		{
			setSubcategories(<?php echo e(old('category')); ?>, '<?php echo e(old('subcategories')); ?>');
		}
		<?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('back.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\valexa\resources\views\back\products\create.blade.php ENDPATH**/ ?>